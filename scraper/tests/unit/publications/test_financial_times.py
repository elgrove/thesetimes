...
class TestFinancialTimes:
    def test_get_articles(self):
        ...
        assert article_urls[0] == 'https://www.ft.com/content/5746165a-3a0c-42c7-9a2e-cb7cf5f33f46'
    ...
    def test_get_article_title(self):
        ...
        assert title == "US Treasuries’ rollercoaster ride strains bond market functioning"
