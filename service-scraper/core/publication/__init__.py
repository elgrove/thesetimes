...
class Publication(abc.ABC):
    ...
    All methods take a WebDriver object to be controlled, and those that act on a single article
        also take the article URL.
    ...
    def get_article_title(self, driver, article_url) -> str:
        ...
        Default implementation uses a meta tag in the html header that most publications have.
        """
